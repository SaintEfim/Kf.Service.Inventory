using AutoMapper;
using Kf.Service.Inventory.API.Controllers.Base;
...
namespace Kf.Service.Inventory.API.Controllers;
    ...
    : ControllerCrudBase<InventoryDto, InventoryModel, IInventoryManager, IInventoryProvider>
{
    ...
    public Task<IActionResult> InventoryCreate(
        ...
        CancellationToken cancellationToken = default)
    {
        return Create<InventoryCreateDto, CreateActionResultDto>(payload, nameof(InventoryGetById), cancellationToken);
    }
